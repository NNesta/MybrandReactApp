        ...
        <div className=" grid lg:grid-cols-2 gap-16 max-w-[90%] mx-auto items-center py-48 ">
          <div className="z-10 flex flex-col items-center justify-center lg:ml-8 text-white">
            ...
            <div className="flex lg:-ml-8 gap-x-8">
              <Link
                className="flex whitespace-nowrap items-center font-normal bg-transparent border-2 border-white rounded-none btn group"
                to="works"
                smooth={true}
                duration={500}
              >
                View My Works{" "}
                <span className="duration-300 ease-in-out group-hover:rotate-90">
          ...
          <div className="items-center justify-center hidden lg:flex flex-1">
            <img
              className="object-cover w-64 h-64 border-4 border-white rounded-full custom-shadow transform -rotate-2"
              src="assets/profile-3 (2).jpg"
              alt=""
            />
            {/*  <-- inner --> */}
            <div className="absolute flex items-center justify-between border border-gray-500 rounded-full hw-inner animate-spin-slow">
              <div className="w-10 h-10 p-1 transform -translate-x-5 bg-black rounded-full custom-shadow anim-8s">
                <img
                  className="object-center w-10 h-10 overflow-hidden animate-rotate-img anim-8s"
              ...
              <div className="bg-white rounded-full custom-shadow h-10 w-10 transform -translate-x-5 translate-y-[8rem] anim-8s">
                <img
                  className="object-cover w-10 h-10 rounded-full animate-rotate-img anim-8s"
              ...
              <div className="bg-white rounded-full custom-shadow h-10 w-10 transform translate-x-[4.5rem] -translate-y-[12rem] anim-8s">
                <img
                  className="object-center w-10 h-10 rounded-full animate-rotate-img anim-8s"
            ...
            <div className="absolute flex items-center justify-between border border-gray-500 rounded-full hw-outer animate-spin-slow">
              ...
              <div className="bg-white rounded-full custom-shadow h-10 w-10 transform -translate-x-[5.5rem] -translate-y-[11rem] anim-8s">
                <img
                  className="object-center w-10 h-10 rounded-full animate-rotate-img anim-8s"
                  src="assets/Docker_logo_PNG15.png"
                  alt=""
                />
              </div>
              ...
              <div className="bg-white rounded-full custom-shadow h-10 w-10 transform -translate-x-[6.2rem] translate-y-[16rem] anim-8s">
                <img
                  className="object-center w-10 h-10 overflow-hidden rounded-full animate-rotate-img anim-8s"
